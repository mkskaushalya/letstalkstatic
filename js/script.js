...
$(document).ready(function () {
  $("#contformsubmit").click(function (event) {
    ...
    var getURL =
      "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfG7iKG_k3FVL-VRjrXs4cymw2fkwdvsFPkytGYnaTn4zpLaA/formResponse?usp=pp_url&entry.24391898=" +
      contname +
      "&entry.1389486660=" +
      contemail +
      "&entry.2045416024=" +
      ...
      contmessage;
    var localGetURL =
      "/inc/run/action.php?contformsubmit=contformsubmit&contname=" +
      contname +
      "&contemail=" +
      contemail +
      "&contphone=" +
...
sr.reveal(
  ".ups, .team-name, .occard, .mySwiper, .headline, .eventdescription, .midline, .evntcard, .eventdetcard, .mid, .nav, .ypsl, .imgcard, .contcard"
);
